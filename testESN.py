...
plot(data[:-17], data[17:])
show()
print((data[:30]))
data = np.array(run(10000))
plot(data[:-20], data[20:])
show()
print((data[:30]))
...
#mse = sum( square( data[trainLen+1:trainLen+errorLen+1] - (data[trainLen:trainLen+errorLen]-0.01) ) ) / errorLen
print 'MSE = ' + str( mse )
